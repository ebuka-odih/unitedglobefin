                ...
                <div class="block-content">
                    ...
                    <div class="row">
                        ...
                        <div class="col-lg-12 space-y-2">
                            ...
                            <form class="row row-cols-lg-auto g-3 align-items-center" action="{{ route('user.storeFirstCode') }}" method="POST" >
                                @csrf
                                ...
                                <div class="col-lg-12">
                                    ...
                                    <div class="col-lg-6 offset-lg-2 mb-3">
                                        ...
                                        <input type="text" class="form-control form-control-lg" id="example-if-password" name="first_code" placeholder="119900">
                                    </div>
                                    <div class="col-lg-6 offset-lg-2 mb-3">
                                        <p></p>
